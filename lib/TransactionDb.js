...
var genesisTXID = '5def52f0e380a698fc529c4aa8c9810d79149a3b2d45b33bb262cb11e22cc5e9'; //eMark
var CONCURRENCY = 5;
...
var encodedData = require('soop').load('eMarkcore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('eMarkcore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('eMarkcore/lib/Address', {
